...
import com.amaker.personalinfo.adapter.TestAdapter;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case Config.Upload_food_menu://收到Adapter的数据
                    ...
                    Food_Menu foodMenu = (Food_Menu) arr.get(0);
...
//                    break;
                    ...
                    param.put(Config.REQUEST_PARAMETER_FOOD_NAME, foodMenu.getFood_name());
                    System.out.println("upload---foodname:" + foodMenu.getFood_name());
                    param.put(Config.REQUEST_PARAMETER_FOOD_DESCRIPTION, foodMenu.getFood_description());
                    param.put(Config.REQUEST_PARAMETER_FOOD_PRICE, foodMenu.getFood_price());
                    param.put(Config.REQUEST_PARAMETER_FOOD_TYPE, foodMenu.getFood_type());
                    param.put(Config.REQUEST_PARAMETER_SHOP_ID, foodMenu.getShop_id());
                    param.put(Config.REQUEST_PARAMETER_FOOD_IMG_64, foodMenu.getImage_64());
                ...
                case Config.Delete_food_menu:
                    ...
                    int position = msg.getData().getInt(Config.DELETE_FOOD_MENU_POSITON);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case Config.STATUS_OK://网络请求成功，但响应需要根据实际来操作
                    Toast.makeText(TestA.this, "您已经上传成功!!", Toast.LENGTH_SHORT).show();
                    Result result = JSONObject.parseObject(msg.obj.toString(), Result.class);
                    System.out.println("result:" + result);
                    break;
                default:
                    Toast.makeText(TestA.this, "上传失败!!", Toast.LENGTH_SHORT).show();
                    break;
            }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new TestAdapter(TestA.this, handler, foodMenuList, false);
...
//                            OkHttpUtil.post(Config.URL_UPLOAD_FOOD_MENU, param, upload_handler);
        ...
        add_new_food.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                adapter.notifyItemRangeChanged(count,1);
            }
        });
